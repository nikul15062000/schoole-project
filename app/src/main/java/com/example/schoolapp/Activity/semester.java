...
import com.example.schoolapp.Adapter.semseterAdapter;
...
public class semester extends AppCompatActivity {
    ...
    private void getData() {
        ...
        Query checkUser = myRef.child (Constant.standard);
        checkUser.addListenerForSingleValueEvent (new ValueEventListener () {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                try {
                    ...
                    Toast.makeText (semester.this, ""+e.getMessage (), Toast.LENGTH_SHORT).show ();
                }
                semseteradp.notifyDataSetChanged ();
                pd.show ();
                pd.cancel ();
            }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText (semester.this, "error", Toast.LENGTH_SHORT).show ();
                pd.dismiss ();
                pd.cancel ();
            }
        });
    ...
    private void SetRecycleView() {
        ...
        semseteradp = new semseterAdapter (this, nameList);
        recyclerView.setAdapter (semseteradp);
    }
}